...
public class Remove_Staff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ENTER STAFF DETAILS");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 60, 290, 40));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("ENTER STAFF ID OR STAFF NAME");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 150, 240, 40));
        ...
        getContentPane().add(t1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, 410, 40));

        removebtn.setBackground(new java.awt.Color(204, 204, 204));
        removebtn.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        removebtn.setText("REMOVE");
        removebtn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        removebtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                removebtnActionPerformed(evt);
            }
        });
        getContentPane().add(removebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 250, 140, 40));
        ...
        getContentPane().add(cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 250, 140, 40));
    ...
    private void removebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removebtnActionPerformed
        ...
        try
        {
            ...
            if(rows>0)
            {
                JOptionPane.showMessageDialog(this,input+" has been removed from database");
            }
            else
            {
